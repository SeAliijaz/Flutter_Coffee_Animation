...
///Color
const Color kCafeBrown = Color(0xff632B13);
              ...
              children: [
                ...
                Center(
                  child: AnimatedOpacity(
                    ...
                    child: const Text(
                      'C A F É',
                      style: TextStyle(fontSize: 50.0, color: kCafeBrown),
                    ),
                  ),
                ),
              ],
